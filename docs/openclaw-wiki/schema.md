...
> Governance document for the OpenClaw Architecture Wiki.
...
- **Name:** OpenClaw Architecture Wiki
- **Purpose:** Human-readable and machine-readable knowledge base documenting the `openclaw/` monorepo: gateway control plane, agent runtime, channels, plugins, routing, sessions, automation, apps, and device surfaces.
- **Created:** 2026-04-06
...
|-------|----------|-------|------------|
| **Raw Sources** | `openclaw/` | Human-curated repository | Immutable by wiki operations |
...
Document a concrete subsystem or package boundary in OpenClaw.
...
Important APIs, contracts, runtime concepts, or directory-level abstractions.
...
Document a cross-cutting pattern that spans multiple OpenClaw systems.
...
Document how multiple OpenClaw systems compose into higher-level behavior.
...
- **Source references:** backtick-wrapped paths relative to `openclaw/`
...
### Ingest
1. Scan changed paths inside `openclaw/`
